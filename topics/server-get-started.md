...
<procedure>
  <step>
    <p>Open the <control>Application.kt</control> file. You should find code similar to the following:</p>
...
<procedure>
  <step>
    <p>Open <control>Application.kt</control> file and find the <code>configureRouting()</code> function.</p>
  </step>
  <step>
    ...
    <p>Alternatively, you can navigate to the function by opening the file <control>Routing.kt</control>.</p>
...
<procedure>
  <step>
    <p>Open the <control>Routing.kt</control> file.</p>
...
<procedure>
    <step>
        <p>Open <control>ApplicationTest.kt</control> and add the code below:</p>
        <code-block lang="kotlin">
...
<procedure title="Add a new dependency" id="add-dependency">
  <p>In the <control>Project</control> tool window, navigate to the <code>src/test/kotlin</code> folder and follow the steps:</p>
    <step>
        <p>Open the <control>build.gradle.kts</control> file.</p>
    </step>
    <step>
...
<procedure title="Install the plugin and specify an exception handler" id="install-plugin-and-specify-handler">
    <step>
        <p>Navigate to the <code>configureRouting()</code> method in <control>Routing.kt</control> and add the following lines of code:</p>
        <code-block lang="kotlin"
                    src="snippets/server-get-started/src/main/kotlin/com/example/plugins/Routing.kt"
